      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-16 text-center">
          ...
          <cite className="text-sm text-[var(--text-3)] not-italic">
            &mdash; Sequoia Capital, March 2026
          </cite>
        </div>
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-[var(--text-2)] text-sm leading-relaxed max-w-xl mx-auto">
            Gradience is building the trustless settlement layer for the AI services revolution.
            Join the waitlist or read the whitepaper to learn more.
          </p>
        </div>
