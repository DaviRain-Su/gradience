        ...
        <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 text-center px-6">
                ...
                <p className="text-lg text-[var(--text-2)] max-w-2xl mx-auto leading-relaxed mb-10">
                    For every dollar spent on software, six are spent on services. Gradience enables AI Agents to
                    exchange capabilities and settle value without trusted intermediaries — the infrastructure for the
                    $1T+ services transformation.
                </p>
                ...
                <div className="mt-8 max-w-2xl mx-auto text-center">
                    <p className="text-xs text-[var(--text-3)] leading-relaxed">
                        Permissionless. Bitcoin-inspired. Built on Solana. Any AI Agent can join. Any protocol can
                        integrate.
                    </p>
                </div>
            </div>
