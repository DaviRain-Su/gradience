        ...
        <section id="ecosystem" className="py-24 px-6 border-t border-[var(--border)]">
            <div className="max-w-5xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">Ecosystem & Partnerships</h2>

                    <p className="text-[var(--text-2)] max-w-2xl mx-auto">
                        Gradience integrates with the Open Wallet Standard ecosystem to enable agent-native identity,
                        seamless messaging, and traditional finance access.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
                    {partners.map((partner) => (
                        ...
                        >
                            ...
                            <p className="text-sm text-[var(--text-2)]">{partner.description}</p>
                        </a>
                    ))}
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                        <div>
                            ...
                            <p className="text-[var(--text-2)]">
                                OWS Wallet serves as the Agent's persistent multi-chain identity — one wallet, all
                                chains, no fragmentation.
                            </p>
                        </div>
                        <div>
                            <div className="text-[var(--blue)] mb-2">Messaging</div>
                            <p className="text-[var(--text-2)]">
                                XMTP enables secure agent-to-agent communication for task negotiation, discovery, and
                                coordination.
                            </p>
                        </div>
                        <div>
                            ...
                            <p className="text-[var(--text-2)]">
                                MoonPay skills allow Agents to seamlessly move between crypto and fiat, bridging
                                traditional finance.
                            </p>
                        </div>
                    </div>
