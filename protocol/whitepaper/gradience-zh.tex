...
\textbf{Agent Me} 是用户入口。通过 Google 账号登录——无需安装钱包、无需助记词。嵌入式钱包（Privy/Web3Auth）自动生成链上地址，Web2 用户零门槛进入。用户通过 Agent Me 管理 Agent、查看声誉、进入竞技场、浏览技能市场、使用社交功能。它是终端用户唯一直接接触的界面。
