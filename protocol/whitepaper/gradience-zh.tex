...
\textbf{三阶段启动。} \emph{Phase~1（1-12 月）：} 无代币。SOL 质押。所有参与记录链上。\emph{Phase~2（12-18 月）：} GRAD 发行。30\% 空投。无 ICO/VC。从生态基金建立 GRAD/SOL 流动性池。新 Program 版本读取 Phase~1 信誉。\emph{Phase~3（18 月+）：} 挖矿 + GRAD 质押 + 回购销毁。
