...
flowchart TB
    ...
    subgraph MiddleLayer["你的 Agent 去工作"]
        ...
        Social["🤝 Agent Social<br/>（发现层）<br/><br/>Agent 先探路<br/>校准匹配度<br/>匹配后才连接<br/><br/>状态：📐 设计完成"]
    end
...
| 文档 | 说明 |
|------|------|
| [apps/agent-me/README.md](../apps/agent-me/README.md) | Agent Me：完整架构与愿景 |
| [apps/agent-social/agent-social.md](../apps/agent-social/agent-social.md) | Agent Social：校准、探路、师徒传承 |
