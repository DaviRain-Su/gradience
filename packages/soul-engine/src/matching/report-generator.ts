...
export class ReportGenerator {
    ...
    static generate(params: {
        ...
        const compatibilityScore = Math.round(
            embeddingScore * options.weights.embedding + llmScore * options.weights.llm,
        );
    ...
    private static generateMarkdown(params: {
        ...
        lines.push('|-----------|-------|--------|');
        lines.push(
            `| Embedding Similarity | ${embeddingScore.toFixed(1)} | ${(options.weights.embedding * 100).toFixed(0)}% |`,
        );
        ...
        lines.push('---\n');
        lines.push(
            '*This report was generated by Soul Engine - AI-powered compatibility analysis for agents and humans.*',
        );
