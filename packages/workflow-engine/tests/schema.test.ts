...
describe('WorkflowSchema', () => {
  describe('validate()', () => {
    ...
    it('should accept all supported actions', () => {
      const actions = [
        'swap', 'bridge', 'transfer', 'yieldFarm', 'stake', 'unstake', 'borrow', 'repay',
        'x402Payment', 'mppStreamReward', 'teePrivateSettle', 'zeroGasExecute',
        'zkProveIdentity', 'zkProveReputation', 'verifyCredential', 'linkIdentity',
        'nearIntent', 'aiAnalyze', 'aiDecide',
        'httpRequest', 'wait', 'condition', 'parallel', 'loop', 'setVariable', 'log',
      ] as const;
