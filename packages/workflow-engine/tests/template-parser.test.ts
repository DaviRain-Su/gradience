...
describe('TemplateParser', () => {
  describe('parseTemplate()', () => {
    ...
    it('should parse simple variable', () => {
      const context: TemplateContext = new Map([
        ['step1', createStepResult({ output: { value: 100 } })],
      ]);
    ...
    it('should parse step properties directly', () => {
      const context: TemplateContext = new Map([
        ['step1', createStepResult({ txHash: '0xabc123' })],
      ]);
    ...
    it('should parse status property', () => {
      const context: TemplateContext = new Map([
        ['step1', createStepResult({ status: 'completed' })],
      ]);
    ...
    it('should handle mixed text and variables', () => {
      const context: TemplateContext = new Map([
        ['step1', createStepResult({ output: { amount: '1000' } })],
      ]);
      expect(parseTemplate('Amount: {{step1.output.amount}} USDC', context)).toBe(
        'Amount: 1000 USDC'
      );
    });
    ...
    it('should handle number values', () => {
      const context: TemplateContext = new Map([
        ['step1', createStepResult({ output: { price: 99.99 } })],
      ]);
    ...
    it('should handle boolean values', () => {
      const context: TemplateContext = new Map([
        ['step1', createStepResult({ output: { success: true } })],
      ]);
    ...
    it('should handle null output', () => {
      const context: TemplateContext = new Map([
        ['step1', createStepResult({ output: undefined })],
      ]);
      expect(parseTemplate('{{step1.output.value}}', context)).toBe('{{step1.output.value}}');
    });
    ...
    it('should handle deeply nested null values', () => {
      const context: TemplateContext = new Map([
        ['step1', createStepResult({ output: { data: null } })],
      ]);
      expect(parseTemplate('{{step1.output.data.value}}', context)).toBe(
        '{{step1.output.data.value}}'
      );
    });

    it('should handle array values in output', () => {
      const context: TemplateContext = new Map([
        ['step1', createStepResult({ output: { items: [1, 2, 3] } })],
      ]);
    ...
    it('should handle object values in output', () => {
      const context: TemplateContext = new Map([
        ['step1', createStepResult({ output: { obj: { a: 1 } } })],
      ]);
  ...
  describe('parseTemplateValue()', () => {
    it('should parse strings', () => {
      const context: TemplateContext = new Map([
        ['step1', createStepResult({ output: { value: 'test' } })],
      ]);
    ...
    it('should parse objects recursively', () => {
      const context: TemplateContext = new Map([
        ['step1', createStepResult({ output: { amount: '100' } })],
      ]);
      const input = {
    ...
    it('should parse arrays recursively', () => {
      const context: TemplateContext = new Map([
        ['step1', createStepResult({ output: { a: '1', b: '2' } })],
      ]);
