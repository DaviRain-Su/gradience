...
export class FeeEstimator {
     ...
     */
    async getEstimate(commitment: 'processed' | 'confirmed' | 'finalized' = 'confirmed'): Promise<PriorityFeeEstimate> {
        // Check cache
     ...
     */
    private async fetchEstimate(commitment: 'processed' | 'confirmed' | 'finalized'): Promise<PriorityFeeEstimate> {
        ...
        if (data.error) {
            throw new CascadeError(CascadeErrorCodes.UNKNOWN_ERROR, data.error.message, {
