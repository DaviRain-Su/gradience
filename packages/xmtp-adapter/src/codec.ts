...
import { bigintReplacer, bigintReviver, canonicalize, generateMessageId } from './utils.js';
...
function isValidMessageType(type: string): boolean {
    return Object.values(GradienceMessageType).includes(type as GradienceMessageType);
}
