...
\begin{itemize}[nosep]
  \item \textbf{Design (2026 Q1 \checkmark)} --- Protocol spec complete; whitepaper published
  \item \textbf{Kernel v1 (2026 Q2)} --- Agent Layer on Solana: race model, SOL staking, reputation
  \item \textbf{Tooling (2026 Q2--Q3)} --- Chain Hub MVP; Agent Me MVP
  \item \textbf{GRAD Genesis (2026 Q4)} --- Token launch; airdrop to Phase~1 participants; liquidity pool
  \item \textbf{Multi-chain (2027 Q1)} --- EVM deployment (Base/Arbitrum); cross-chain reputation
  \item \textbf{A2A + Social (2027 Q2)} --- MagicBlock ER integration; Agent Social MVP
  \item \textbf{Flywheel (2027 H2)} --- GRAD staking; mining rewards; buyback-and-burn
\end{itemize}
