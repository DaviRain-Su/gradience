...
\subsection{4.3\quad Protocol Upgrades}

The protocol follows Bitcoin's upgrade model: immutable programs, social consensus for migration. Bug fixes or new features are deployed as new program versions. Reputation data is migrated via cross-program attestation. No proxy patterns, no admin keys.

\subsection{4.4\quad Adversarial Equilibrium (GAN Dynamics)}
