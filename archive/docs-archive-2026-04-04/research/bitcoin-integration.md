...
async function createTaskRewardInvoice(taskId: string, amountSats: number, agentPubkey: string): Promise<string> {
...
async function agentPayForService(serviceUrl: string, invoice: string): Promise<ServiceResponse> {
...
function createReputationAnchorTx(anchor: ReputationAnchor, fundingUtxo: UTXO, senderKeyPair: ECPairInterface): string {
...
async function verifyReputationAnchor(txid: string, expectedAgentPubkey: string): Promise<ReputationAnchor | null> {
...
async function agentSignBitcoinTx(unsignedTx: string, agentId: string): Promise<string> {
...
_Next Steps: Technical Spec (Phase 3)_
