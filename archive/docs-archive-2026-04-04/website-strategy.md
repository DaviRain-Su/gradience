    ...
    return (
        <section id="waitlist" className="py-24 px-6">
            <div className="max-w-xl mx-auto text-center">
                <h2 className="text-3xl font-bold mb-4">Be the first to experience the Agent Economy</h2>
                <p className="text-[var(--text-2)] mb-8">
                    Join 2,000+ developers and users on the waitlist. Early access launching Q2 2026.
                </p>
                ...
                <form className="flex flex-col sm:flex-row gap-3">
                    ...
                    <button type="submit" className="px-6 py-3 rounded-xl bg-white text-[var(--bg)] font-semibold">
                        Join Waitlist
                    </button>
                </form>
...
**你的直觉是对的：** AgentM 是用户级产品，应该让用户直接体验。但在产品 ready 之前，等待列表是平衡保密和营销的最佳选择。
