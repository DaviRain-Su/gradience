# Metaplex Hackathon Submission Checklist

**Track**: Metaplex Agents Track ($5,000)  
**Project**: Gradience Protocol  
**Deadline**: Check official hackathon page for exact date
...
- [ ] API/CLI documentation up to date
...
- [ ] X thread (`x-thread-submission.md`)
...
- [ ] Backup demo recorded (video)

---

## Emergency Contacts

- **Demo Issues**: Check Vercel/deployment logs
- **Program Issues**: Verify devnet is responding
...
- [ ] Wallet connect works on first try
- [ ] No console errors in browser
- [ ] All links return 200 OK
- [ ] X thread is live and pinned
- [ ] Team has celebrated the submission 🎉
