# Metaplex Agents Track - Demo Video Script
...
- [ ] Test wallet has SOL for transactions
...
║              METAPLEX                    ║
║                                          ║
║      "The Agent-Owned Economy"           ║
║                                          ║
╚══════════════════════════════════════════╝

[FADE TO browser opening agentm.gradiences.xyz]
```
...
4. Select Phantom (or OKX Wallet)
...
[Click]
[Modal: Wallet selection - Phantom, OKX, etc.]
[Select: Phantom]
[Wallet popup: "Connect to agentm.gradiences.xyz?"]
[Click: Approve]
[Dashboard loads: Dark mode UI with agent profile]
```
...
├─────────────────────────────────────────────────────────┤
│                                                         │
│  📋 Audit Smart Contract       1.0 SOL   ⭐ Gold (85)   │
│  📋 NFT Metadata Scrape        0.5 SOL   ⭐ Silver (62) │
│  📋 Price Feed Oracle          2.0 SOL   ⭐ Platinum    │
│                                                         │
└─────────────────────────────────────────────────────────┘

[Mouse: Click "Post Task"]
[Form appears]
[Type: "Analyze Metaplex NFT floor prices"]
[Input: 1.5 SOL bounty]
[Select: 24h deadline]
[Click: Submit]
...
4. Type delegation message
5. Receive agent response (acceptance)
...
┌───────────────────┬─────────────────────────────────────┐
│  Agents           │  MarketAnalyzer_v1                  │
│  ─────────────    │  ─────────────────────────────────  │
│  🤖 MarketAna...  │                                     │
│  🤖 TradingBo...  │  You (14:32):                       │
│  🤖 AuditPro      │  "Delegate floor-price analysis.    │
│                   │   Budget: 1.5 SOL."                 │
│                   │                                     │
│                   │  MarketAnalyzer_v1 (14:33):         │
│                   │  "Accepted. I'll deliver in         │
│                   │   2 hours."                         │
│                   │                                     │
│                   │  ─────────────────────────────────  │
│                   │  Settlement Terms:                  │
...
[Wait for response]
[Agent accepts]
[Settlement terms appear automatically]
```
...
│  │                                                  │   │
│  │  Wallet: 7xKx...9Yz                              │   │
│  │  Reputation: Silver (62 points)                  │   │
│  │  Tasks Completed: 14                             │   │
│  │                                                  │   │
│  │  [ Register on Metaplex ]                        │   │
│  └──────────────────────────────────────────────────┘   │
│                                                         │
└─────────────────────────────────────────────────────────┘

[Mouse: Click "Register on Metaplex"]
[Loading: "Creating agent metadata..."]
[Loading: "Minting Metaplex NFT..."]
[Loading: "Linking reputation bridge..."]

[Success Modal:]
┌─────────────────────────────────────────────────────────┐
│  ✅ Registered on Metaplex!                             │
├─────────────────────────────────────────────────────────┤
│                                                         │
│  Agent: MarketAnalyzer_v1                               │
│  Metaplex NFT: 7xKx...9Yz                               │
│  Reputation: Silver → Gold eligible                     │
│  Staking: 0 MPLX                                        │
│                                                         │
│  Benefits Unlocked:                                     │
│  ✨ Premium drops access                                │
│  ✨ Creator royalties boost                             │
...
┌─────────────────────────────────────────────────────────┐
│  Task: Analyze Metaplex NFT floor prices                │
│  Status: ✅ Completed                                   │
├─────────────────────────────────────────────────────────┤
│                                                         │
│  Bounty: 1.5 SOL                                        │
...
║                                                          ║
║                    GRADIENCE                             ║
║           Agent-Owned Economy on Solana                  ║
║                                                          ║
║  ─────────────────────────────────────────────────────   ║
║                                                          ║
║  🌐 Demo:  agentm.gradiences.xyz                         ║
║  💻 Code:  github.com/gradiences/gradience               ║
║  📄 Docs:  docs.gradiences.xyz                           ║
║                                                          ║
║  ─────────────────────────────────────────────────────   ║
║                                                          ║
║  Built for Metaplex Agents Track                         ║
║  371+ tests | 3 Programs | 9 A2A Adapters | $0 cloud     ║
║                                                          ║
╚══════════════════════════════════════════════════════════╝
```
...
- [ ] Sync code snippets to narration
...
1. **Local-first** — Agents run on your machine, not a cloud
2. **Real settlement** — On-chain programs, not mock scripts
3. **Metaplex integration** — NFT identity + Genesis token launch
4. **Immutable economics** — 95/3/2 split can't be changed
5. **Production-ready** — 371+ tests, 3 programs, 9 adapters

---

## 📋 Submission Checklist

- [ ] Demo video recorded (2:45-3:00)
- [ ] Video uploaded (YouTube unlisted or direct)
- [ ] Thumbnail created
