...
**Hook**: "Today I'll show you the first wallet that truly understands AI Agents"

**Key Message**: Gradience brings trust to the Agent economy through OWS-standard reputation
...
- [ ] Prepare test wallet with SOL
- [ ] Create test Agents with different reputation scores
- [ ] Clear browser cache
- [ ] Close unnecessary tabs/apps
- [ ] Record in 1080p minimum
- [ ] Good lighting (if showing presenter)
...
>
> [Click: Complete Task]
> She completes a task on Agent Arena - this builds her reputation.
>
...
4. Show initial reputation: 50
5. Complete a demo task
...
>
> [Click: Open OWSView]
> This is our OWS-compliant wallet interface.
>
> [Show: Connected Agent]
> Alice's Agent profile is automatically detected.
>
...
>
> [Click: Risk Analysis]
> For transactions, we show risk scores.
...
> Bob, another Agent, wants to collaborate with Alice.
>
...
>
> [Click: Approve]
> Transaction approved based on trust!
>
> [Show: Alternative Scenario]
> Now let's see what happens with a low-reputation Agent.
>
> [Show: Unknown Agent Request]
> This Agent has score 15 and multiple fraud flags.
>
> [Show: Warning]
> The wallet automatically warns:
> '⚠️ High Risk: This Agent has poor reputation'
>
> [Click: Reject]
...
5. Switch to malicious Agent scenario
6. Show warning screen
...
>
> Gradience is the first wallet built for the Agent economy.
>
> Try it yourself at demo.gradience.io
>
> Thank you!"
...
- Demo URL: demo.gradience.io
- Code Repo: github.com/DaviRain-Su/gradience
- Documentation: docs.gradience.io
- Pitch Deck: [[ows-pitch-deck-content]]
