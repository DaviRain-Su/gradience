 ...
 * Demo Soul Profiles
 * 
 * Pre-defined Soul Profiles for demonstration purposes
 */
...
/**
 * Get a demo profile by ID
 */
export function getDemoProfile(id: string): SoulProfile | undefined {
  return demoProfiles.find(p => p.id === id);
}

/**
 * Get all demo profiles except one
 */
...
/**
 * Get random demo profiles
 */
export function getRandomDemoProfiles(count: number): SoulProfile[] {
