...
- **Action**: 🚨 Critical - needs immediate focus
...
- **Action**: Complete remaining tasks for prize
...
- **Action**: Finish last task to claim prize!
...
- **Completed Projects**: 6/14 (43%)
- **Near Complete (>80%)**: 4/14 (29%)
- **In Progress (50-80%)**: 2/14 (14%)
- **Just Started (<50%)**: 2/14 (14%)
