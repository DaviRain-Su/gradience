...
5. **跨链统一**: 无论 Agent 在 Solana、Base 还是 Arbitrum 上活跃，最终输出一套标准化分数。
...
const TEMPLATES: Record<string, ReputationTemplate> = {
  default: {
    ...
    weights: { performance: 0.30, activity: 0.15, economic: 0.15, reliability: 0.15, expertise: 0.10, social: 0.075, security: 0.05, temporal: 0.025 },
  },
  
  highStake: {
    name: 'high-stake',
    description: '高价值/高风险任务，看重经济抵押和可靠性',
    weights: { performance: 0.20, activity: 0.10, economic: 0.30, reliability: 0.20, expertise: 0.15, social: 0.00, security: 0.05, temporal: 0.00 },
  },
  
  defiAudit: {
    name: 'defi-audit',
    description: 'DeFi 审计任务，看重专业能力和可靠性',
    weights: { performance: 0.25, activity: 0.10, economic: 0.15, reliability: 0.25, expertise: 0.20, social: 0.025, security: 0.025, temporal: 0.00 },
  },
  
  dataScraping: {
    name: 'data-scraping',
    description: '数据抓取/流水线任务，看重活跃度和任务量',
    weights: { performance: 0.35, activity: 0.25, economic: 0.10, reliability: 0.15, expertise: 0.05, social: 0.05, security: 0.025, temporal: 0.025 },
  },
  
  community: {
    name: 'community',
    description: '社区运营/内容创作，看重社交影响力',
    weights: { performance: 0.20, activity: 0.15, economic: 0.10, reliability: 0.15, expertise: 0.05, social: 0.30, security: 0.025, temporal: 0.025 },
  },
  
  lendingCollateral: {
    name: 'lending-collateral',
    description: '借贷协议抵押率评估，只看经济和可靠性',
    weights: { performance: 0.10, activity: 0.05, economic: 0.45, reliability: 0.30, expertise: 0.00, social: 0.00, security: 0.10, temporal: 0.00 },
  },
};
```
