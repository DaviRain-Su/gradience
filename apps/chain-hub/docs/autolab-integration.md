...
export const AUTOLAB_PROTOCOL = {
    ...
    // 能力声明
    capabilities: ['browser_automation', 'web_scraping', 'form_filling', 'data_extraction', 'workflow_automation'],
...
_AutoLabHQ 整合方案 v1.0 · 2026-04-02_  
_维护者: Gradience Chain Hub Team_
