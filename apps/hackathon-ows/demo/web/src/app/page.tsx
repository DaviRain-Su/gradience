  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-black text-white">
      ...
      <div className="max-w-6xl mx-auto p-6">
        {activeTab === 'overview' ? <Overview /> : <DemoSection />}
      </div>
    </main>
  );
}
    ...
    <div className="space-y-12">
      ...
      >
        ...
        <p className="text-xl text-gray-400 max-w-2xl mx-auto">
          The first identity layer that combines OWS standard with verifiable on-chain reputation.
          Every agent deserves a name — and a score.
        </p>
      </motion.div>
