...
impl InitializeBuilder {
    ...
    #[inline(always)]
    pub fn upgrade_authority(&mut self, upgrade_authority: [u8; 32]) -> &mut Self {
        self.upgrade_authority = Some(upgrade_authority);
        self
    }
    #[inline(always)]
    pub fn min_judge_stake(&mut self, min_judge_stake: u64) -> &mut Self {
        self.min_judge_stake = Some(min_judge_stake);
        self
    }
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = InitializeInstructionArgs {
            ...
            min_judge_stake: self
                .min_judge_stake
                .clone()
                .expect("min_judge_stake is not set"),
        };
...
impl<'a, 'b> InitializeCpiBuilder<'a, 'b> {
    ...
    #[inline(always)]
    pub fn min_judge_stake(&mut self, min_judge_stake: u64) -> &mut Self {
        self.instruction.min_judge_stake = Some(min_judge_stake);
        self
    }
    /// Add an additional account to the instruction.
    #[inline(always)]
