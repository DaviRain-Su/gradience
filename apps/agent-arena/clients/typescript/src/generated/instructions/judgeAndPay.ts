  ...
  InstructionWithAccounts<
    [
      ...
      TAccountWinnerAccount extends string
        ? WritableAccount<TAccountWinnerAccount>
...
> {
  ...
  return Object.freeze({
    ...
    data: getJudgeAndPayInstructionDataEncoder().encode(
      args as JudgeAndPayInstructionDataArgs,
    ),
    programAddress,
...
export function parseJudgeAndPayInstruction<
