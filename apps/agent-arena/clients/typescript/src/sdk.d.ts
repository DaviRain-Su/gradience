...
export declare class GradienceSDK {
    ...
    readonly instructions: {
        readonly initialize: (input: Parameters<typeof getInitializeInstruction>[0], config?: Parameters<typeof getInitializeInstruction>[1]) => import("./index.js").InitializeInstruction<Address, string, string, string, string, []>;
        readonly postTask: (input: Parameters<typeof getPostTaskInstruction>[0], config?: Parameters<typeof getPostTaskInstruction>[1]) => import("./index.js").PostTaskInstruction<Address, string, string, string, string, string, string, string, string, string, string, string, string, string, []>;
        readonly applyForTask: (input: Parameters<typeof getApplyForTaskInstruction>[0], config?: Parameters<typeof getApplyForTaskInstruction>[1]) => import("./index.js").ApplyForTaskInstruction<Address, string, string, string, string, string, string, string, string, string, string, string, string, []>;
        readonly submitResult: (input: Parameters<typeof getSubmitResultInstruction>[0], config?: Parameters<typeof getSubmitResultInstruction>[1]) => import("./index.js").SubmitResultInstruction<Address, string, string, string, string, string, string, string, []>;
        readonly judgeAndPay: (input: Parameters<typeof getJudgeAndPayInstruction>[0], config?: Parameters<typeof getJudgeAndPayInstruction>[1]) => import("./index.js").JudgeAndPayInstruction<Address, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, []>;
        readonly cancelTask: (input: Parameters<typeof getCancelTaskInstruction>[0], config?: Parameters<typeof getCancelTaskInstruction>[1]) => import("./index.js").CancelTaskInstruction<Address, string, string, string, string, string, string, string, string, string, string, string, string, string, []>;
        readonly refundExpired: (input: Parameters<typeof getRefundExpiredInstruction>[0], config?: Parameters<typeof getRefundExpiredInstruction>[1]) => import("./index.js").RefundExpiredInstruction<Address, string, string, string, string, string, string, string, string, string, string, string, []>;
        readonly forceRefund: (input: Parameters<typeof getForceRefundInstruction>[0], config?: Parameters<typeof getForceRefundInstruction>[1]) => import("./index.js").ForceRefundInstruction<Address, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, []>;
        readonly registerJudge: (input: Parameters<typeof getRegisterJudgeInstruction>[0], config?: Parameters<typeof getRegisterJudgeInstruction>[1]) => import("./index.js").RegisterJudgeInstruction<Address, string, string, string, string, string, string, string, []>;
        readonly unstakeJudge: (input: Parameters<typeof getUnstakeJudgeInstruction>[0], config?: Parameters<typeof getUnstakeJudgeInstruction>[1]) => import("./index.js").UnstakeJudgeInstruction<Address, string, string, string, string, string, []>;
        readonly upgradeConfig: (input: Parameters<typeof getUpgradeConfigInstruction>[0], config?: Parameters<typeof getUpgradeConfigInstruction>[1]) => import("./index.js").UpgradeConfigInstruction<Address, string, string, []>;
    };
    readonly task: {
