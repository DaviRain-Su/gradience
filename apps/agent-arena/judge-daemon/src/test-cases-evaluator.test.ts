...
const WASM_SCORE_80 = Uint8Array.from([
    ...
    0x07, 0x09, 0x01, 0x05, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x00, 0x00, 0x0a, 0x07, 0x01, 0x05, 0x00, 0x41, 0xd0, 0x00,
    0x0b,
]);

const WASM_FLOAT_OPCODE = Uint8Array.from([
    0x00, 0x61, 0x73, 0x6d, 0x01, 0x00, 0x00, 0x00, 0x01, 0x05, 0x01, 0x60, 0x00, 0x01, 0x7f, 0x03, 0x02, 0x01, 0x00,
    0x07, 0x09, 0x01, 0x05, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x00, 0x00, 0x0a, 0x0d, 0x01, 0x0b, 0x00, 0x43, 0x00, 0x00,
    0x80, 0x3f, 0x1a, 0x41, 0xd0, 0x00, 0x0b,
]);

const WASM_SCORE_139 = Uint8Array.from([
    0x00, 0x61, 0x73, 0x6d, 0x01, 0x00, 0x00, 0x00, 0x01, 0x05, 0x01, 0x60, 0x00, 0x01, 0x7f, 0x03, 0x02, 0x01, 0x00,
    0x07, 0x09, 0x01, 0x05, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x00, 0x00, 0x0a, 0x07, 0x01, 0x05, 0x00, 0x41, 0x8b, 0x01,
    0x0b,
]);

const WASM_WITH_IMPORT = Uint8Array.from([
    0x00, 0x61, 0x73, 0x6d, 0x01, 0x00, 0x00, 0x00, 0x01, 0x04, 0x01, 0x60, 0x00, 0x00, 0x02, 0x0b, 0x01, 0x03, 0x65,
    0x6e, 0x76, 0x03, 0x66, 0x6f, 0x6f, 0x00, 0x00,
]);
