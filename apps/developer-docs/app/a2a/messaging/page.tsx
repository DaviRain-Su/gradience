export default function A2AMessagingPage() {
        ...
        <div className="prose">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>
                            <code>initialize_network</code>
                        </td>
                        <td>Setup network config</td>
                    </tr>
                    <tr>
                        <td>
                            <code>send_message</code>
                        </td>
                        <td>Send message to another agent</td>
                    </tr>
                    <tr>
                        <td>
                            <code>acknowledge_message</code>
                        </td>
    ...
    "timestamp": 1712100000
            ...
            <h2>Runtime Relay</h2>
            <p>
                For off-chain messaging, use the A2A Runtime relay server which provides HTTP + WebSocket transport with
