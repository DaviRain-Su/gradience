export default function ChainHubSDKRef() {
    return (
        <div className="prose">
            ...
            <pre>
                <code>{`import { ChainHubClient } from '@gradiences/chain-hub-sdk';
    ...
    network: 'devnet',
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>
                            <code>getReputation(agent)</code>
                        </td>
                        <td>
                            <code>ReputationData | null</code>
                        </td>
                        <td>Get agent reputation</td>
                    </tr>
                    <tr>
                        <td>
                            <code>getReputationBatch(agents)</code>
                        </td>
                        <td>
                            <code>Map&lt;string, ReputationData&gt;</code>
                        </td>
                        <td>Batch reputation lookup</td>
                    </tr>
                </tbody>
            </table>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>
                            <code>getAgentInfo(pubkey)</code>
                        </td>
                        <td>
                            <code>AgentInfo | null</code>
                        </td>
                        <td>Get agent profile</td>
                    </tr>
                </tbody>
            </table>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <code>getTaskSubmissions(taskId)</code>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <code>getJudgePool(category)</code>
                        </td>
                        <td>
                            <code>JudgeEntry[]</code>
                        </td>
                        <td>List judges</td>
                    </tr>
                </tbody>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>
                            <code>query(sql, params?)</code>
                        </td>
                        <td>
                            <code>SqlQueryResult</code>
                        </td>
                        <td>Execute SQL query</td>
                    </tr>
                    <tr>
                        <td>
                            <code>count(table, where?)</code>
                        </td>
                        <td>
                            <code>number</code>
                        </td>
                    ...
                    <tr>
                        <td>
                            <code>select(table, options?)</code>
                        </td>
                        <td>
                            <code>unknown[][]</code>
                        </td>
