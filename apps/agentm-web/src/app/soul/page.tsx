...
function MatchingReportView({ report, onClose }: { report: MatchingReport; onClose: () => void }) {
...
export default function SoulPage() {
    ...
    const handleEndProbe = () => {
        ...
        // Generate report
        const targetProfile = discoveredProfiles.find((p) => p.id === activeProbeSession.targetId);
    ...
    return (
        <div style={containerStyle}>
            ...
            >
                ...
                >
                    Discover compatible souls through AI-powered matching
                </p>
            </div>
                    ...
                    <div>
                        {!profile && !isEditingProfile ? (
                            ...
                            <div>
                                ...
                                <SoulProfileCard profile={profile} showActions={false} />
                            </div>
                        ) : null}
                    </div>
                )}
                    ...
                    <div>
                        ...
                        {!profile ? (
                            ...
                            >
                                ...
                                >
                                    Create your Soul Profile first to discover matches
                                </p>
                                <button
