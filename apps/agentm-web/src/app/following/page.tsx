        ...
        <div style={{ minHeight: '100vh', background: c.bg }}>
            ...
            <div style={{ maxWidth: '900px', margin: '0 auto', padding: '24px' }}>
                {!walletAddress ? (
                    ...
                    <div style={{ textAlign: 'center', padding: '48px', color: '#DC2626' }}>Error: {error}</div>
                ) : list.length === 0 ? (
                        ...
                        {list.map(
                            (agent: {
                                ...
                                >
                                    ...
                                    >
                                        <div>
                                            <div style={{ fontWeight: 700, fontSize: '16px', color: c.ink }}>
                                                {agent.reputation ?? '-'}
                                            </div>
                                            <div
                                                style={{
                                        ...
                                        <FollowButton
                                            ...
                                            isFollowing={
                                                activeTab === 'following' ? true : (agent.isFollowing ?? false)
                                            }
                                            onFollow={follow}
                                            onUnfollow={unfollow}
                                            size="md"
