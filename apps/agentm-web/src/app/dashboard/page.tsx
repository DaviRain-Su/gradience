            ...
            <div style={styles.header}>
                <div style={styles.headerContent}>
                    <div>
                        ...
                        <p style={styles.subtitle}>Overview of your AgentM activity and metrics</p>
                    </div>
                    {walletAddress && (
                    ...
                    <>
                        ...
                        <div style={styles.dashboardCard}>
                            <div style={styles.cardHeader}>
                                ...
                                <p style={styles.cardDescription}>Enter a query to get a custom data view</p>
                            </div>
