                ...
                <ProfileCard
                  ...
                  onPublish={async (candidate) => {
                    try {
                      ...
                      setToastMessage({ type: 'error', message: `Failed to publish ${candidate.name}` });
                    }
                  }}
                  onDeprecate={async (candidate) => {
                    try {
                      ...
                      setToastMessage({ type: 'error', message: `Failed to deprecate ${candidate.name}` });
                    }
                  }}
                  onDelete={async (candidate) => {
                    try {
                      ...
                      setToastMessage({ type: 'error', message: `Failed to delete ${candidate.name}` });
                    }
                  }}
                  disabled={loading}
                />
