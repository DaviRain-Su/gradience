      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '32px 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: '24px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            {/* Soul Profile Card */}
            {profile.soulProfile && <SoulProfileCard profile={profile.soulProfile as any} showActions={false} />}
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                {[
                  ...
                  { label: 'Published', value: profiles.filter((p) => p.status === 'published').length },
                  ...
                  >
                    <span style={{ fontSize: '13px', color: c.ink, opacity: 0.7 }}>{stat.label}</span>
                    <span style={{ fontSize: '14px', fontWeight: 600, color: c.ink }}>{stat.value}</span>
                  </div>
                ))}
              </div>
            </div>
