        ...
        <div style={styles.container}>
            ...
            <div style={styles.header}>
                <div style={styles.headerContent}>
                    ...
                    <p style={styles.subtitle}>Manage your account, wallet, and preferences</p>
                </div>
            </div>
                        ...
                        {walletAddress ? (
                            <>
                                ...
                                <div style={{ marginTop: '20px', display: 'flex', gap: '12px' }}>
                                    <button style={styles.buttonSecondary}>Copy Address</button>
                                    <button style={styles.buttonDanger}>Disconnect</button>
                                </div>
                            </>
                        ) : (
                    ...
                    <div style={styles.sectionContent}>
                        ...
                        <div style={{ ...styles.settingItem, borderBottom: 'none' }}>
                            <div style={styles.settingInfo}>
                                ...
                                <div style={styles.settingDescription}>Number of agent profiles you have created</div>
                            </div>
                            <div style={styles.settingValue}>
                    ...
                    <div style={styles.sectionContent}>
                        <div style={styles.settingItem}>
                            <div style={styles.settingInfo}>
                                ...
                                <div style={styles.settingDescription}>Receive updates and alerts via email</div>
                            </div>
                            <div
                        ...
                        <div style={styles.settingItem}>
                            <div style={styles.settingInfo}>
                                ...
                                <div style={styles.settingDescription}>Notify when someone mentions you</div>
                            </div>
                            <div
                        ...
                        <div style={{ ...styles.settingItem, borderBottom: 'none' }}>
                            <div style={styles.settingInfo}>
                                ...
                                <div style={styles.settingDescription}>Notify when someone follows you</div>
                            </div>
                            <div
                    ...
                    <div style={styles.sectionContent}>
                        <div style={styles.settingItem}>
                            <div style={styles.settingInfo}>
                                ...
                                <div style={styles.settingDescription}>Make your profile visible to everyone</div>
                            </div>
                            <div
                        ...
                        <div style={styles.settingItem}>
                            <div style={styles.settingInfo}>
                                ...
                                <div style={styles.settingDescription}>Display your reputation score publicly</div>
                            </div>
                            <div
                        ...
                        <div style={{ ...styles.settingItem, borderBottom: 'none' }}>
                            <div style={styles.settingInfo}>
                                ...
                                <div style={styles.settingDescription}>Let others find you in agent discovery</div>
                            </div>
                            <div
                    ...
                    <div style={styles.sectionContent}>
                        <div style={styles.infoCard}>
                            <p style={styles.infoText}>
                                Your wallet connection is secured via Dynamic. Private keys never leave your device.
                            </p>
                        </div>
                        <div style={{ display: 'flex', gap: '12px' }}>
                            <button style={styles.buttonSecondary}>View Connected Apps</button>
