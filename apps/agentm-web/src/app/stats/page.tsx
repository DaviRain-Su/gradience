            ...
            <div style={styles.header}>
                <div style={styles.headerContent}>
                    <div>
                        ...
                        <p style={styles.subtitle}>Your performance metrics and reputation overview</p>
                    </div>
                    {walletAddress && (
                    ...
                    <>
                        ...
                        <div style={styles.card}>
                            <div style={styles.cardHeader}>
                                ...
                                <p style={styles.cardDescription}>Your standing in the AgentM network</p>
                            </div>
                            <div style={styles.cardContent}>
                                <div style={styles.reputationBar}>
                                    <div style={{ ...styles.reputationFill, width: `${reputationPercent}%` }} />
                                </div>
                        ...
                        <div style={styles.card}>
                            <div style={styles.cardHeader}>
                                ...
                                <p style={styles.cardDescription}>Your latest actions and updates</p>
                            </div>
                            <div style={styles.cardContent}>
                        ...
                        <div style={styles.card}>
                            <div style={styles.cardHeader}>
                                ...
                                <p style={styles.cardDescription}>Earnings from completed tasks and services</p>
                            </div>
                            <div style={styles.cardContent}>
                                <div style={styles.chartPlaceholder}>
                                    <BarChart3 size={48} color={c.ink} style={{ opacity: 0.2 }} />
                                    <span style={styles.placeholderText}>Revenue tracking coming soon</span>
                                </div>
                            </div>
                        </div>
                    </>
