...
export default function CreateTaskPage() {
    ...
    const [subtasks, setSubtasks] = useState<SubtaskInput[]>([{ title: '', description: '', budget: '' }]);
    ...
    const totalSubtaskBudget = subtasks.reduce((sum, s) => sum + (parseFloat(s.budget) || 0), 0);
    ...
    return (
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 20px' }}>
            ...
            <div style={{ marginBottom: '32px' }}>
                ...
                <h1 style={{ fontSize: '32px', fontWeight: 700, margin: 0 }}>Create Multi-Agent Task</h1>
            </div>
            ...
            {step === 1 && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                        ...
                        <div>
                            <label style={{ display: 'block', fontWeight: 600, marginBottom: '8px' }}>Deadline *</label>
                            <input
                                type="datetime-local"
                                value={deadline}
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                        <div>
                            <label style={{ display: 'block', fontWeight: 600, marginBottom: '8px' }}>Priority</label>
                            <select
                                value={priority}
            ...
            {step === 2 && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                    <div>
                        <h2 style={{ fontSize: '20px', fontWeight: 600, margin: '0 0 8px 0' }}>Define Subtasks</h2>
                    ...
                    {subtasks.map((subtask, index) => (
                        ...
                        >
                            ...
                            >
                                <h3 style={{ fontSize: '16px', fontWeight: 600, margin: 0 }}>Subtask {index + 1}</h3>
                                {subtasks.length > 1 && (
                                    <button
                    ...
                    >
                        <p style={{ margin: 0, fontSize: '14px' }}>
                            ...
                            {totalSubtaskBudget > parseFloat(budget) && (
                                <span style={{ color: '#dc2626', marginLeft: '8px' }}>(Over budget!)</span>
                            )}
                        </p>
                    </div>
            ...
            {step === 3 && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                    <div>
                        <h2 style={{ fontSize: '20px', fontWeight: 600, margin: '0 0 8px 0' }}>Review & Create</h2>
                        <p style={{ color: '#666', margin: 0 }}>Review your task before creating it</p>
                    </div>
