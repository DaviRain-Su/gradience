    ...
    return (
        <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '40px 20px' }}>
            <div style={{ marginBottom: '24px' }}>
                ...
                <h1 style={{ fontSize: '28px', fontWeight: 700, margin: '16px 0 8px 0' }}>{task.title}</h1>
                <p style={{ fontSize: '16px', color: '#666', margin: 0 }}>{task.description}</p>
            </div>
            ...
            >
                <div>
                    ...
                    <strong>
                        {parseInt(task.budget.spent) / 1e6} / {parseInt(task.budget.total) / 1e6} {task.budget.token}
                    </strong>
                </div>
                <div>
