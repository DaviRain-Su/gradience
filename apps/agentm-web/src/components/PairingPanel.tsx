...
export function PairingPanel({
    ...
    return (
      <div style={styles.container}>
        ...
        <p style={styles.description}>
          Your local agent is now connected. You can start chatting!
        </p>
  ...
  return (
    <div style={styles.container}>
      ...
      <p style={styles.description}>
        To use AgentM, you need to run the local bridge on your machine.
        Copy the code below and run:
      </p>

      <code style={styles.command}>
        npx @gradience/bridge-cli --pair-code {'<code>'}
      </code>
      ...
      <div style={styles.help}>
        <details>
          ...
          <div style={styles.helpContent}>
            <p><strong>What is the local bridge?</strong></p>
            <p>
              The local bridge connects your browser to your local AgentM instance.
              It allows you to interact with your agents securely.
            </p>
            <p><strong>Installation:</strong></p>
            <code style={styles.inlineCode}>
              npm install -g @gradience/bridge-cli
            </code>
            <p><strong>Run:</strong></p>
            <code style={styles.inlineCode}>
              bridge-cli --pair-code {pairCode || 'XXXXXXX'}
            </code>
          </div>
        </details>
      </div>
