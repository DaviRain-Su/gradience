            ...
            {preferred && (
                ...
                >
                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                        <span style={{ fontSize: '13px', fontWeight: 600, color: '#0F172A' }}>Preferred Session</span>
                    ...
                    .map((s) => (
                        ...
                        >
                            <div style={{ display: 'flex', flexDirection: 'column' }}>
                                <span style={{ fontSize: '13px', fontWeight: 600, color: '#16161A' }}>{s.id}</span>
                                <span style={{ fontSize: '12px', color: '#888' }}>
                                    {s.lastCommitAt
                                        ? `Last commit ${formatDelta(now, new Date(s.lastCommitAt))}`
                                        : 'No commits yet'}
                                </span>
                            </div>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
