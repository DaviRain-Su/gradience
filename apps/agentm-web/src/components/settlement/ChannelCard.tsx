    ...
    return (
        <div style={styles.card}>
            ...
            <div style={styles.payee}>
                <span style={styles.label}>Payee:</span> <code style={styles.code}>{channel.payee}</code>
            </div>

            <div style={styles.expires}>Expires: {new Date(channel.expiresAt).toLocaleString()}</div>
            ...
            <div style={styles.actions}>
                ...
                {channel.status === 'disputed' && <div style={styles.disputeNote}>Under dispute resolution</div>}
            </div>
        </div>
    );
}
