...
interface JudgeSubmissionViewProps {
    ...
    onJudge: (params: { winner: Address | `0x${string}`; score: number; reasonRef: string }) => void;
    loading?: boolean;
}
...
export function JudgeSubmissionView({ task, submissions, onJudge, loading }: JudgeSubmissionViewProps) {
    ...
    return (
        <div style={styles.container}>
            ...
            <p style={styles.split}>
                Winner: {formatTokenAmount(agentPayout, chain)} · Judge: {formatTokenAmount(judgeFee, chain)} ·
                Protocol: {formatTokenAmount(protocolFee, chain)}
            </p>
