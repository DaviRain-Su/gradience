            ...
            {registered ? (
                    ...
                    {registrationData && (
                        <div style={{ fontSize: '12px', color: '#666' }}>
                            <p style={{ margin: '0 0 4px 0' }}>
                                Agent ID: <span style={{ fontFamily: 'monospace' }}>{registrationData.agentId}</span>
                            </p>
                            <p style={{ margin: 0 }}>
                                TX:{' '}
                                <a
                ...
                <>
                    <p style={{ fontSize: '13px', color: '#666', marginBottom: '12px' }}>
                        Register this agent on the ERC-8004 Identity Registry to enable cross-chain reputation tracking
                        and verification.
                    </p>
