 ...
 */
export function ERC8004FeedbackForm({
  agentId,
  taskId,
  onSubmitted,
  onCancel,
}: ERC8004FeedbackFormProps) {
  ...
  return (
    <div style={cardStyle}>
      ...
      <p style={{ fontSize: '13px', color: '#666', marginBottom: '16px' }}>
        Rate this agent's performance. Your feedback will be recorded on the ERC-8004 Reputation
        Registry and contribute to their cross-chain reputation score.
      </p>
