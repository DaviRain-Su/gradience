...
function ReputationScoreCircle({
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ fontSize: sizeConfig.text, fontWeight: 700, color: tierConfig.color }}>
          {score}
        </span>
...
function PolicyLimits({
  ...
  if (compact) {
    return (
      <div style={{ display: 'flex', alignItems: 'center', gap: '16px', fontSize: '12px', color: COLORS.ink, opacity: 0.6 }}>
        <span>
          Daily: <span style={{ color: COLORS.ink, fontWeight: 600, opacity: 1 }}>{formatUsdCents(policy.dailyLimit)}</span>
        </span>
        <span>
          Max TX: <span style={{ color: COLORS.ink, fontWeight: 600, opacity: 1 }}>{formatUsdCents(policy.maxTransaction)}</span>
        </span>
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
      ...
      >
        <p style={{ fontSize: '12px', color: COLORS.ink, opacity: 0.5, margin: '0 0 4px 0' }}>Max Transaction</p>
        <p style={{ fontSize: '18px', fontWeight: 700, color: COLORS.ink, margin: 0 }}>
...
function ReputationStats({ reputation }: { reputation: ReputationData }) {
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '8px', textAlign: 'center' }}>
      <div>
        <p style={{ fontSize: '20px', fontWeight: 700, color: COLORS.ink, margin: 0 }}>{reputation.completed}</p>
      ...
      <div>
        <p style={{ fontSize: '20px', fontWeight: 700, color: COLORS.ink, margin: 0 }}>{reputation.totalApplied}</p>
...
export function ReputationWallet({
  ...
  if (!wallet) {
    return (
      ...
      >
        <p style={{ color: COLORS.ink, opacity: 0.6, marginBottom: '8px', marginTop: 0 }}>No wallet connected</p>
