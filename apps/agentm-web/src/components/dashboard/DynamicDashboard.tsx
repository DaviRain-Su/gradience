...
export function DynamicDashboard({
  ...
  const publishedRatio = stats.totalProfiles > 0
    ? (stats.publishedProfiles / stats.totalProfiles) * 100
    : 0;
              ...
              <>
                <div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
                    ...
                    <span style={styles.statValue}>{stats.publishedProfiles} / {stats.totalProfiles}</span>
                  </div>
