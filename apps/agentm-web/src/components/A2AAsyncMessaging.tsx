...
export function A2AAsyncMessaging() {
  ...
  const sendMessage = useCallback(() => {
    ...
    const message: AsyncMessage = {
      ...
      timestamp: Date.now(),
      status: 'pending',
      metadata: messageType === 'payment_request' ? {
        ...
        {selectedAgentId ? (
          ...
          <div style={{
            ...
            <p style={{
              ...
              Send messages, delegate tasks, and request payments from other agents.
              Messages are delivered even when agents are offline.
            </p>
            <button
              onClick={() => setShowNewMessageModal(true)}
              style={{
                  ...
                  >
                    ...
                    <div>
                      <p style={{
                        ...
                        fontWeight: 700,
                        margin: 0,
                      }}>{agent.displayName || agent.agentId.slice(0, 8)}</p>
                      <p style={{
                        fontSize: '12px',
                        opacity: 0.6,
                        margin: 0,
