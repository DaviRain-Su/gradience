...
describe('useIdentity', () => {
    ...
    describe('bindWallet', () => {
        it('returns binding data on success', async () => {
            ...
            expect(mockConnection.fetchApi).toHaveBeenCalledWith('/api/v1/identity/bind', {
                method: 'POST',
                body: JSON.stringify({
                    accountId: 'acc1',
                    primaryWallet: '0xWallet',
    ...
    describe('getTier', () => {
        it('returns tier info on success', async () => {
            ...
            expect(mockConnection.fetchApi).toHaveBeenCalledWith('/api/v1/identity/tier/acc1');
    ...
    describe('getBinding', () => {
        it('returns binding info on success', async () => {
            ...
            expect(mockConnection.fetchApi).toHaveBeenCalledWith('/api/v1/identity/binding/0xWallet');
    ...
    describe('verifyZkKyc', () => {
        it('returns verified response on success', async () => {
            ...
            expect(mockConnection.fetchApi).toHaveBeenCalledWith('/api/v1/identity/zk-verify', {
                method: 'POST',
                body: JSON.stringify({
                    accountId: 'acc1',
                    nullifierHash: '0xNull',
