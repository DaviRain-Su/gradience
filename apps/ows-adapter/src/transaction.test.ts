...
describe('serializeTransaction', () => {
  it('should serialize a Transaction to base64', () => {
    const tx = new Transaction({ recentBlockhash: '11111111111111111111111111111111', feePayer: new PublicKey('11111111111111111111111111111111') });
...
describe('signSolanaTransaction', () => {
  ...
  it('should throw if wallet is null', async () => {
    await expect(signSolanaTransaction(null as any, new Transaction({ recentBlockhash: '11111111111111111111111111111111', feePayer: new PublicKey('11111111111111111111111111111111') }))).rejects.toThrow('Wallet is required');
  });
  ...
  it('should throw for invalid wallet response', async () => {
    ...
    await expect(
      signSolanaTransaction(
        badWallet,
        new Transaction({ recentBlockhash: '11111111111111111111111111111111', feePayer: new PublicKey('11111111111111111111111111111111') })
      )
...
describe('createSignTransactionHandler', () => {
  ...
  it('should return a handler function', async () => {
    ...
    const result = await handler(new Transaction({ recentBlockhash: '11111111111111111111111111111111', feePayer: new PublicKey('11111111111111111111111111111111') }));
