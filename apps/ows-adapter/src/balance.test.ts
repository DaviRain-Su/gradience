...
describe('checkTokenBalance', () => {
    ...
    it('should throw if connection is missing', async () => {
        await expect(checkTokenBalance(null as any, '11111111111111111111111111111111', 'mint123')).rejects.toThrow(
            'Connection is required',
        );
    });
...
describe('checkTokenBalances', () => {
    ...
    it('should check multiple token balances', async () => {
        ...
        const results = await checkTokenBalances(mockConnection, '11111111111111111111111111111111', [mintA, mintB]);
