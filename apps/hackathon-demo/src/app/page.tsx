        ...
        <main className="min-h-screen p-4 md:p-8">
            ...
            >
                <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
                    ...
                    <br />
                    <span className="text-2xl md:text-3xl text-gray-400">with Privy Authentication</span>
                </h1>
                <p className="text-lg text-gray-400 max-w-2xl mx-auto">
                    A universal wallet adapter supporting MetaMask, Phantom, OKX Wallet, and more. Combined with
                    Privy&apos;s seamless social login and embedded wallet infrastructure.
                </p>
            </motion.section>
