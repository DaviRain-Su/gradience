...
export function PrivyLogin() {
            ...
            >
                ...
                <div className="space-y-2 mb-4">
                    <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-gray-300">{user.linkedAccounts?.length || 0} linked accounts</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm">
                        <Wallet className="w-4 h-4 text-blue-400" />
                        <span className="text-gray-300">
                            {user.wallet?.walletClientType === 'privy' ? 'Embedded Wallet (Privy)' : 'External Wallet'}
                        </span>
                    </div>
                </div>
                ...
                {user.wallet && (
                    <div className="bg-black/30 rounded-lg p-3 mb-4">
                        ...
                        <p className="text-sm font-mono text-green-400 break-all">{user.wallet.address}</p>
                    </div>
                )}
    ...
    return (
        <motion.div
            ...
            className="bg-gradient-to-br from-purple-900/50 to-blue-900/50 rounded-xl p-6 border border-purple-500/30"
        >
            <h2 className="text-xl font-bold text-white mb-2">Connect with Privy</h2>
            <p className="text-gray-400 text-sm mb-6">Social login + Wallet infrastructure</p>
