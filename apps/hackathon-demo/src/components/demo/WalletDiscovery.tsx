      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-xl font-bold text-white">
            OWS Wallet Discovery
          </h2>
          <p className="text-gray-400 text-sm">
            Open Wallet Standard - Universal wallet connector
          </p>
        </div>
        <button
        ...
        {wallets.map((wallet) => (
          ...
          >
            <img 
              ...
              onError={(e) => {
                (e.target as HTMLImageElement).src = 'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="6" width="18" height="12" rx="2"/></svg>';
              }}
            />
