...
export class OWSSdkBridge {
    ...
    signAgentMessage(wallet: string, chain: string, message: string, credential?: string): OWSSignResult {
    ...
    signAgentTransaction(wallet: string, chain: string, txHex: string, credential?: string): OWSSignResult {
    ...
    listAgentApiKeys(): Array<{ id: string; name: string; walletIds: string[]; policyIds: string[] }> {
        return listApiKeys(this.vaultPath) as Array<{
            id: string;
            name: string;
            walletIds: string[];
            policyIds: string[];
