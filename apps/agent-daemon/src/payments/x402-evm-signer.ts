...
import { type Hex, type Chain, type Account, keccak256, toHex, concat, pad, hexToSignature } from 'viem';
...
export async function buildPermitSignature(
    ...
    return buildPermitSignatureWithDomain(tokenDomain, { owner, spender, value, nonce, deadline }, signer);
}
