...
vi.mock('@magicblock-labs/ephemeral-rollups-sdk', () => ({
  ...
  createCreatePermissionInstruction: vi.fn().mockReturnValue({ programId: new PublicKey('ACLseoPoyC3cBqoUtkbjZ4aDrkurZW86v19pXz2XQnp1'), keys: [], data: Buffer.alloc(8) }),
  createUpdatePermissionInstruction: vi.fn().mockReturnValue({ programId: new PublicKey('ACLseoPoyC3cBqoUtkbjZ4aDrkurZW86v19pXz2XQnp1'), keys: [], data: Buffer.alloc(8) }),
  createDelegatePermissionInstruction: vi.fn().mockReturnValue({ programId: new PublicKey('ACLseoPoyC3cBqoUtkbjZ4aDrkurZW86v19pXz2XQnp1'), keys: [], data: Buffer.alloc(8) }),
  createCommitAndUndelegatePermissionInstruction: vi.fn().mockReturnValue({ programId: new PublicKey('ACLseoPoyC3cBqoUtkbjZ4aDrkurZW86v19pXz2XQnp1'), keys: [], data: Buffer.alloc(8) }),
}));
