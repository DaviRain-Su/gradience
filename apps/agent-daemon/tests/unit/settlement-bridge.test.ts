    ...
    return {
        ...
        Connection: vi.fn().mockImplementation(() => ({
            getLatestBlockhash: vi
                .fn()
                .mockResolvedValue({ blockhash: 'EETubP5YHMYCHsT6dDeeH', lastValidBlockHeight: 123456789 }),
            sendRawTransaction: vi
                .fn()
                .mockResolvedValue(
                    '2nBr3UHQZf1K5WwVWBnV6dKtX5VHBdQJNZmQW1RmzZzZqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQqQ',
                ),
    ...
    describe('settlement', () => {
        it('should settle evaluation result', async () => {
            const mockEvaluationResult: EvaluationResult = {
                ...
                score: 85,
                passed: true,
                categoryScores: [{ name: 'Functionality', score: 90, maxScore: 100, weight: 0.5, feedback: [] }],
