...
describe.skipIf(SKIP_E2E)('Revenue Distribution E2E', () => {
    ...
    describe('SOL Distribution', () => {
        it('should distribute SOL correctly with 95/3/2 split', async () => {
            ...
            try {
                ...
                const totalDistributed =
                    result.breakdown.agent.amount + result.breakdown.judge.amount + result.breakdown.protocol.amount;
        ...
        it('should handle insufficient escrow balance', async () => {
            ...
            await expect(distributor.distribute(request, payer)).rejects.toThrow();
        });
    });
    ...
    describe('Error Handling', () => {
        ...
        it('should handle transaction simulation failure', async () => {
            ...
            await expect(distributor.distribute(request, wrongSigner)).rejects.toThrow();
        });
    });
            ...
            const testCases = [
                {
                    ...
                    expectedAgent: BigInt(950_000_000),
                    expectedJudge: BigInt(30_000_000),
                    expectedProtocol: BigInt(20_000_000),
                },
                {
                    total: BigInt(100_000_000),
                    expectedAgent: BigInt(95_000_000),
                    expectedJudge: BigInt(3_000_000),
                    expectedProtocol: BigInt(2_000_000),
                },
                {
                    total: BigInt(10_000_000),
                    expectedAgent: BigInt(9_500_000),
                    expectedJudge: BigInt(300_000),
                    expectedProtocol: BigInt(200_000),
                },
            ];
